...
1. What does Herramientas Rentables explain?
...
Dinero, negocios y tecnología sin humo.  
Ideas útiles para decidir mejor.  
↓ Herramientas gratis

### Link rule

Use the owned Herramientas Rentables site as the primary destination unless an experiment explicitly tests a different owned landing page.
...
Purpose: explain the recurring promise.

Core message:
"Aquí no publicamos motivación vacía. Cada semana desarmamos números, decisiones y mecanismos que pueden hacerte perder tiempo o dinero si nadie te los explica."

CTA: follow for the next useful explanation.

### PIN-02 — Proof of value

Use one of the highest-performing educational pieces, initially KV-000002 or another winner from Cohort 001.

Purpose: demonstrate the quality of the content instead of describing it.

### PIN-03 — Free utility

Show the useful free tools available on the Herramientas Rentables site.
...
- compatible header/cover treatment;
...
High profile visits + low follows -> profile promise or pinned proof is weak/confusing.

High follows + low returning audience -> content promise may not be delivered consistently.
